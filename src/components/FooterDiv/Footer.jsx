  ...
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-[8] grid grid-cols-5 m-auto items-center justify-center'>
      <div>
        ...
        <p className='text-white pb-[13px] opacity-70 leading-7'>We always make our seekers and companies<br></br> find the best jobs and employees to find the best candidates.</p>
      </div>
      ...
      <div className="grid">
        ...
        <div className="">
          <small className='text-[14px] text-white'>abulhasanat902@gmail.com</small>
